...
def main():
    ...
    # Ward on n role centroids yields n-1 merges, so at most n-1 families can be
    # cut and Z[-(k-1)] must stay in range. Full runs have 276 roles and never
    # bind; smoke tests with --roles do.
