...
def write_stamp(run_dir, data_dirs=None) -> Path:
    """Write provenance.json into `run_dir`. Never raises — a failed stamp must
    not kill a science run; it records the failure instead."""
